...
## 🔴 The Problem
Standard file management relies on generic extensions (like `.pdf` or `.jpg`), leading to cluttered folders filled with vaguely named documents such as `Final_v3.pdf`. This lacks project-specific context and wastes valuable time when searching for critical files.

## 🟢 The Solution
This AI-powered agent analyzes the actual semantics of your filenames to understand their purpose. It intelligently groups related items into practical, project-based folders—matching your personal organizational style—and provides an automated **audit report** for every new cluster.
...
### 1. Prerequisites
- Python 3.8+
- Google Gemini API Key: Obtain a free key from [Google AI Studio](https://ai.google/).
...
### 🛠️ Usage
Place your unorganized files into a folder you want to organize in the same directory as the script.
